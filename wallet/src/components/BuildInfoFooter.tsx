...
export function BuildInfoFooter() {
  ...
  return (
    <footer className="py-4 text-center text-[10px] text-gray-400 select-none">
      v{__APP_VERSION__} ·{' '}
      <a
        href={`${REPO_URL}/commit/${__APP_COMMIT__}`}
        target="_blank"
        rel="noreferrer"
        className="font-mono hover:text-domovina-navy underline-offset-2 hover:underline"
...
function formatBuildTime(iso: string): string {
  ...
  // Compact local-friendly form: 2026-05-22 14:23 UTC
